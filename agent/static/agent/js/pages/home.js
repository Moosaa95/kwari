$(document).ready(function(){
    ...
    $.each(initData.categories, (index,value)=>{
        $("#categoriesDiv").append(
            `<div class="item">
                <a href="#">
                    <img style="width: 100px; height: 100px;" src="/media/${value.image}" alt="${value.category__name}">
    ...
    $.each(productImages, (index,value)=>{
        ...
        const item = `<div class="item">
                                    ...
                                    <div class="content-div">
                                        <a href="/agent/product_detail?product_id=${value.product__id}">
                                            <span><h2 class="fw-600 text-white mb-1">${value.product__name}<br></h2></span>
                                            <span><i class="ti-location-pin mr-2 text-white"></i>Price: ${value.product__agent_price}</span>
                                            <span><i class="ti-location-pin mr-2 text-white"></i>Quantity Available: ${value.product__quantity_left}</span>
                                        </a>
                                    </div>
<!--                                        <i class="ti-heart mt-3 text-red bg-white"></i>-->
                                   </div>`
