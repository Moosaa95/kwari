...
$(document).ready(function(){
    ...
    createAgent.on('click', function(e){
        $('#addAgentForm').ajaxSubmit({
            ...
            beforeSend : function() {
                createAgent.addClass('kt-spinner kt-spinner--v2 kt-spinner--sm kt-spinner--success kt-spinner--right kt-spinner--input');
            },
            success: function(response, status, xhr, $form) {
                ...
                createAgent.removeClass('kt-spinner kt-spinner--v2 kt-spinner--sm kt-spinner--success kt-spinner--right kt-spinner--input');
            }
        });
    });
});
